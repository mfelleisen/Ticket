...
(provide
 ...
 #; {Port# [Listof Player] IP (RemoteManager) *-> Void}
 run-clients
...
;; ---------------------------------------------------------------------------------------------------
(define (run-clients port players ip #:remote-manager [man make-remote-manager])
  (client players port #true ip #:remote-manager man #:quiet #true))
